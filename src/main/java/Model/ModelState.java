...
public class ModelState implements State {
     ...
     */
    public ModelState(int numProcessor) {
     ...
     */
    public ModelState(State parentState, int MaxUnderestimate, Node childTask, int processor, int startTime) {
